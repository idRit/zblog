...
var app = (function () {
    ...
    function create_catch_block$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(p, file$4, 139, 4, 3142);
    		},
    ...
    function create_then_block$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$4, 135, 4, 3033);
    		},
    ...
    // (133:25)       <p>...waiting</p>    {:then aboutMe}
    function create_pending_block$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(p, file$4, 133, 4, 2991);
    		},
    ...
    function create_if_block$2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(span, "class", "border svelte-1k140ls");
    			add_location(span, file$4, 150, 8, 3427);
    			attr(div, "class", "caption svelte-1k140ls");
    			add_location(div, file$4, 149, 6, 3396);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			a3 = element("a");
    			a3.textContent = "reddit";
    			attr(img, "class", "zlogo svelte-1k140ls");
    			attr(img, "width", "75%");
    			attr(img, "height", "75%");
    			attr(img, "src", "https://drive.google.com/uc?export=download&id=1OQD-t5-CHCmGp1IqqVAAfVGLoIG1eouo");
    			attr(img, "alt", "");
    			add_location(img, file$4, 117, 4, 2511);
    			attr(div0, "class", "caption svelte-1k140ls");
    			add_location(div0, file$4, 116, 2, 2484);
    			attr(div1, "class", "bgimg1 svelte-1k140ls");
    			add_location(div1, file$4, 115, 0, 2460);
    			set_style(h30, "text-align", "center");
    			set_style(h30, "font-size", "24px");
    			set_style(h30, "letter-spacing", "10px");
    			add_location(h30, file$4, 129, 2, 2867);
    			attr(div2, "class", "cont svelte-1k140ls");
    			set_style(div2, "color", "white");
    			set_style(div2, "background-color", "black");
    			set_style(div2, "text-align", "center");
    			set_style(div2, "text-align", "justify");
    			add_location(div2, file$4, 127, 0, 2759);
    			set_style(h31, "text-align", "center");
    			set_style(h31, "padding", "50px 80px");
    			set_style(h31, "color", "white");
    			add_location(h31, file$4, 144, 2, 3231);
    			attr(div3, "class", "cards-container svelte-1k140ls");
    			add_location(div3, file$4, 147, 2, 3326);
    			attr(div4, "class", "bgimg2 svelte-1k140ls");
    			add_location(div4, file$4, 143, 0, 3207);
    			set_style(h32, "text-align", "center");
    			add_location(h32, file$4, 167, 2, 3852);
    			attr(a0, "class", "footeritem svelte-1k140ls");
    			attr(a0, "href", "mailto:zeddshaikh@gmail.com");
    			add_location(a0, file$4, 169, 4, 3932);
    			attr(a1, "class", "footeritem svelte-1k140ls");
    			attr(a1, "href", "https://www.instagram.com/zeddshaikh/");
    			add_location(a1, file$4, 172, 4, 4033);
    			attr(a2, "class", "footeritem svelte-1k140ls");
    			attr(a2, "href", "https://www.twitter.com/zeddshaikh/");
    			add_location(a2, file$4, 175, 4, 4133);
    			attr(a3, "class", "footeritem svelte-1k140ls");
    			attr(a3, "href", "https://www.reddit.com/user/zeddshaikh");
    			add_location(a3, file$4, 176, 4, 4215);
    			attr(div5, "class", "footerarea svelte-1k140ls");
    			add_location(div5, file$4, 168, 2, 3902);
    			set_style(footer, "color", "white");
    			set_style(footer, "background-color", "black");
    			set_style(footer, "text-align", "center");
    			set_style(footer, "padding", "10px\r\n  10px");
    			set_style(footer, "text-align", "justify");
    			add_location(footer, file$4, 164, 0, 3733);
    		},
